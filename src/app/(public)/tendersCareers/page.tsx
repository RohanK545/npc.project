...
export default function AboutUs() {
  const tenders = [
    {
      id: "1",
      title: "Corrigendum No: 2 -ancellation tender to engage agencies on rate contract for providing end to end recruitment & examination CPP Portal E-publishing Corrigendum no 2 Tender ID:-2025_NPC_818018_1",
      publishedDate: "20.08.2025",
      dueDate: "",
      fileSize: "244.56 KB",
      link: "https://www.npcindia.gov.in/NPC/Uploads/image/International%20Services/Corrienngdum%20No%202%20for%20Tender%20to%20%20recruitment%20engage%20agencies%20on%20rate%20contract_0001465173.pdf"
    },
    {
      id: "2",
      title: "Corrigendum regarding the extension of the last date for the Limited Tender for supply and installation of 30 Licenses of Microsoft 365 (NPC/ADMN/01/MICROSOFT 365)",
      publishedDate: "18.11.2025",
      dueDate: "23.11.2025",
      fileSize: "197.95 KB",
      link: "https://www.npcindia.gov.in/NPC/Uploads/image/International%20Services/Corriendum%20for%20Micorsoft%20365%20Bussiness%20standard%20software_000153545.pdf"
    },
    {
      id: "3",
      title: "Limited Tender Inviting Quotation for the supply and installation of 30 Licenses of Microsoft 365 (NPC/ADMN/01/MICROSOFT 365)",
      publishedDate: "11.11.2025",
      dueDate: "18.11.2025",
      fileSize: "267.38 KB",
      link: "https://www.npcindia.gov.in/NPC/Uploads/image/International%20Services/Tender%20Doc%20365298622.pdf"
    },
    {
      id: "4",
      title: "TENDER TO ENGAGE AGENCIES ON RATE CONTRACT FOR PROVIDING END TO END RECRUITMENT & EXAMINATION SUPPORT IN CONDUCTING I) COMPUTER BASED TEST (CBT) OR/AND II) OFFLINE TEST (DESCRIPTIVE PEN-PAPER BASED TEST (PBT) OR OMR BASED TEST) ON PAN INDIA BASIS FOR DIFFERENT ORGANIZATIONS (RFP No: NPC/HQ/HRM/T1/RECTT/2025-26) CPP Portal E-publishing Tender ID:-2025_NPC_818018_1 Corrigendum - (RFP No: NPC/HQ/HRM/T1/RECTT/2025-26) CPP Portal E-publishing Corrigendum Tender ID:-2025_NPC_818018_1",
      publishedDate: "06.11.2025",
      dueDate: "21.11.2025",
      fileSize: "221.83 KB",
      link: "https://www.npcindia.gov.in/NPC/Uploads/image/International%20Services/Tender%20for%20Recruitment%20Agency%20HRM%20Group%202025-26362278.pdf"
    }
  ];
    ...
    <div>
      ...
      <section className="maincontent" role="main">
        <div className="container mt-5">
              ...
              <div className="d-flex align-items-center justify-content-end flex-wrap gap-2">
                <div className="input-group sortField">
                  <span className="input-group-text">
                    <span aria-hidden="true" className="material-symbols-outlined bhashini-skip-translation">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 64 64" fill="none">
                        <path d="M8 48V42.6667H24V48H8ZM8 34.6667V29.3333H40V34.6667H8ZM8 21.3333V16H56V21.3333H8Z" fill="#5279d7"/>
                      </svg>
                    </span>
                  </span>
          ...
          <div role="table" aria-label="Tender data" className="d-none d-lg-block">
            <div role="rowgroup" className="row row-gap-2 align-items-center tableheader ms-0 me-0" style={{ backgroundColor: "#a3bbf3" }}>
              <div className="row align-items-center" role="row">
                <div className="col-lg-2" role="columnheader">
                  <small className="text-uppercase">Tender id</small>
                </div>
                <div className="col-lg-3" role="columnheader">
                  <small className="text-uppercase">Title</small>
                </div>
                <div className="col-lg-2" role="columnheader">
                  <small className="text-uppercase">Published Date</small>
                </div>
                <div className="col-lg-2" role="columnheader">
                  <small className="text-uppercase">Due Date</small>
                </div>
                <div className="col-lg-3" role="columnheader">
            ...
            <div role="rowgroup">
              {tenders.map((tender) => (
                <div key={tender.id} role="row" className="announcementbox row row-gap-3 align-items-center ms-0 me-0">
                  <div className="col-lg-2" role="cell">
                    <small className="ptype mb-0 text-break">{tender.id}</small>
                  </div>
                  <div className="col-lg-3" role="cell">
                    <p className="mb-0">{tender.title}</p>
                  </div>
                  <div className="col-lg-2" role="cell">
                    <small className="ptype mb-0">{tender.publishedDate}</small>
                  </div>
                  <div className="col-lg-2" role="cell">
                    <small className="ptype mb-0">{tender.dueDate}</small>
                  </div>
                  <div className="col-lg-3" role="cell">
          ...
          <div className="d-lg-none">
            {tenders.map((tender) => (
              <div key={tender.id} className="mobile-tender-card p-3 mb-3" style={{ border: "1px solid #ddd", borderRadius: "8px", backgroundColor: "#fff", boxShadow: "0 2px 4px rgba(0,0,0,0.08)" }}>
                {/* Header with Tender ID */}
                <div className="mb-3 pb-2" style={{ borderBottom: "2px solid #a3bbf3" }}>
                  <div className="d-flex justify-content-between align-items-center">
                    <span style={{ fontSize: "12px", color: "#666", fontWeight: "600", textTransform: "uppercase" }}>Tender ID</span>
                    <span className="badge" style={{ backgroundColor: "#162F6A", fontSize: "14px", padding: "6px 12px", fontWeight: "600" }}>#{tender.id}</span>
                  </div>
                </div>

                {/* Title */}
                <div className="mb-3">
                  <p className="mb-0" style={{ fontSize: "14px", lineHeight: "1.5", color: "#333", fontWeight: "500" }}>{tender.title}</p>
                </div>

                {/* Dates Grid */}
                <div className="row g-2 mb-3">
                  <div className="col-6">
                    <div className="p-2" style={{ backgroundColor: "#f8f9fa", borderRadius: "6px" }}>
                      <p className="text-muted mb-1" style={{ fontSize: "11px", fontWeight: "600", textTransform: "uppercase" }}>Published</p>
                      <p className="mb-0" style={{ fontSize: "13px", fontWeight: "600", color: "#162F6A" }}>{tender.publishedDate}</p>
                    </div>
                  </div>
                  <div className="col-6">
                    <div className="p-2" style={{ backgroundColor: "#f8f9fa", borderRadius: "6px" }}>
                      <p className="text-muted mb-1" style={{ fontSize: "11px", fontWeight: "600", textTransform: "uppercase" }}>Due Date</p>
                      <p className="mb-0" style={{ fontSize: "13px", fontWeight: "600", color: tender.dueDate ? "#162F6A" : "#999" }}>{tender.dueDate || "N/A"}</p>
                    </div>
                  </div>
                </div>

                {/* Footer with File Size and Action */}
                <div className="d-flex justify-content-between align-items-center pt-2" style={{ borderTop: "1px solid #f0f0f0" }}>
                  <div className="d-flex align-items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 68 68" fill="none">
                      <path fillRule="evenodd" clipRule="evenodd" d="M15.13 47.8714C12.7254 46.6379 9.88617 46.145 7.0975 46.4771H0V67.9281H5.6525V59.741H8.075C10.5846 59.9579 13.1063 59.4402 15.215 58.2752C17.0049 56.9837 17.9917 55.0731 17.8925 53.0912C18.025 51.0785 16.9966 49.1354 15.13 47.8714ZM10.5825 55.701C9.51486 56.0964 8.34103 56.2445 7.1825 56.1301H5.525V50.0523H7.1825C8.38607 49.9447 9.6003 50.144 10.6675 50.6243C11.6614 51.2066 12.2246 52.1813 12.155 53.1984C12.2838 54.2239 11.6623 55.213 10.5825 55.701ZM30.0475 46.4771H22.9925V67.9281H29.75C33.1938 68.2116 36.6618 67.653 39.7375 66.3193C43.1218 64.1975 44.9299 60.7346 44.4975 57.2026C44.7508 54.1767 43.4692 51.2021 40.97 49.0155C37.8829 46.9686 33.9459 46.0537 30.0475 46.4771ZM35.6575 63.0659C33.8869 63.9031 31.8595 64.2766 29.835 64.1384H28.73V50.2668H29.75C33.32 50.2668 34.7225 50.5528 36.125 51.6254C37.8271 53.1161 38.7062 55.1399 38.5475 57.2026C38.7661 59.4349 37.6898 61.6187 35.6575 63.0659ZM50.7025 67.9281H56.44V58.9544H68V55.1648H56.44V50.2668H68V46.4771H50.7025V67.9281ZM46.75 0H0V39.3268H8.5V32.1765V28.4226V7.15033H43.2225L59.5 20.8432V28.4226V32.1765V39.3268H68V17.8758L46.75 0Z" fill="#162F6A"/>
                    </svg>
                    <small style={{ fontSize: "12px", color: "#666", fontWeight: "500" }}>{tender.fileSize}</small>
                  </div>
                  <a href={tender.link} target="_blank" className="btn btn-sm d-flex align-items-center gap-1" style={{ backgroundColor: "#a3bbf3", color: "#000", padding: "6px 14px", borderRadius: "6px", fontSize: "13px", textDecoration: "none", fontWeight: "600", textTransform: "uppercase" }}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 64 64" fill="none">
                      <path d="M32 42.6667C35.3334 42.6667 38.1667 41.5 40.5 39.1667C42.8334 36.8333 44 34 44 30.6667C44 27.3333 42.8334 24.5 40.5 22.1667C38.1667 19.8333 35.3334 18.6667 32 18.6667C28.6667 18.6667 25.8334 19.8333 23.5 22.1667C21.1667 24.5 20 27.3333 20 30.6667C20 34 21.1667 36.8333 23.5 39.1667C25.8334 41.5 28.6667 42.6667 32 42.6667ZM32 37.8667C30 37.8667 28.3 37.1667 26.9 35.7667C25.5 34.3667 24.8 32.6667 24.8 30.6667C24.8 28.6667 25.5 26.9667 26.9 25.5667C28.3 24.1667 30 23.4667 32 23.4667C34 23.4667 35.7 24.1667 37.1 25.5667C38.5 26.9667 39.2 28.6667 39.2 30.6667C39.2 32.6667 38.5 34.3667 37.1 35.7667C35.7 37.1667 34 37.8667 32 37.8667ZM32 50.6667C26.0445 50.6667 20.6111 49.0667 15.7 45.8667C10.7889 42.6667 6.91114 38.4444 4.06669 33.2C3.84447 32.8 3.6778 32.3889 3.56669 31.9667C3.45558 31.5444 3.40002 31.1111 3.40002 30.6667C3.40002 30.2222 3.45558 29.7889 3.56669 29.3667C3.6778 28.9444 3.84447 28.5333 4.06669 28.1333C6.91114 22.8889 10.7889 18.6667 15.7 15.4667C20.6111 12.2667 26.0445 10.6667 32 10.6667C37.9556 10.6667 43.3889 12.2667 48.3 15.4667C53.2111 18.6667 57.0889 22.8889 59.9334 28.1333C60.1556 28.5333 60.3223 28.9444 60.4334 29.3667C60.5445 29.7889 60.6 30.2222 60.6 30.6667C60.6 31.1111 60.5445 31.5444 60.4334 31.9667C60.3223 32.3889 60.1556 32.8 59.9334 33.2C57.0889 38.4444 53.2111 42.6667 48.3 45.8667C43.3889 49.0667 37.9556 50.6667 32 50.6667ZM32 45.3333C37.0222 45.3333 41.6334 44.0111 45.8334 41.3667C50.0334 38.7222 53.2445 35.1555 55.4667 30.6667C53.2445 26.1778 50.0334 22.6111 45.8334 19.9667C41.6334 17.3222 37.0222 16 32 16C26.9778 16 22.3667 17.3222 18.1667 19.9667C13.9667 22.6111 10.7556 26.1778 8.53336 30.6667C10.7556 35.1555 13.9667 38.7222 18.1667 41.3667C22.3667 44.0111 26.9778 45.3333 32 45.3333Z" fill="#000"/>
                    </svg>
                    View
                  </a>
                </div>
