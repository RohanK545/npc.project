      ...
      <div className="container-fluid maincontent">
        <div className="row">
          ...
          <div
            ...
            style={{
              top: "16rem",
              height: "calc(100vh - 6rem)", // leave extra space at the bottom
              marginLeft: "10rem",
              minWidth: "250px",
              maxWidth: "475px",
            }}
          ...
          <div className=" ms-5 col-md-8 ps-5 aboutcontent">
            ...
            <p className="text-justify">
              ...
              the inclusive and sustainable growth of the Electronics, IT & ITeS
              industries, enhancing India’s role in Internet Governance,
            ...
            <div className="row g-4">
                ...
                <div className="objectivebox">
                  ...
                  <p>
                    <span style={{ fontWeight: 400 }}>
                      <strong>e-Innovation / R&amp;D:</strong> Implementation of
                      R&amp;D Framework-Enabling creation of Innovation/ R&amp;D
                      Infrastructure
                    </span>
                  </p>
                </div>
              ...
              <div className="col-md-4">
                <div className="objectivebox">
                  <h3>8</h3>
                  <p>
                    <strong>Internet Governance:</strong> Enhancing India’s role
                    in Global Platforms of Internet Governance
                  </p>
                </div>
              </div>
            </div>
              ...
              <div>
                ...
                <ol>
                  <li>
                    ...
                    Electronics; and Internet (all matters other than licensing
                  ...
                  <li>
                    ...
                    E-Governance, E-Commerce, E-Medicine, E-Infrastructure, etc.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <sup>3</sup>
                    <br />
                    5B.&nbsp; Matters relating to Cyber Security as assigned in
                  ...
                  <li>
                    ...
                    (IFB), Institute for Education in Information Society (IBI)
                    and International Code Council — on line (ICC).
                  </li>
                  <li>
                    Initiative on bridging the Digital Divide: Matters relating
                    to Digital India Corporation.
                    <sup>6</sup>
                  </li>
                  <li>
                ...
                <div>
                  <ol>
                    ...
                    <li>
                      ...
                      (Earlier inserted under Planning Commission vide Amendment
                      Series no.296 dated 22.02.2010, and in NITI Aayog vide
                      series no.312).
                    </li>
                    <li>
              ...
              <div>
                ...
                <div>
                  <p>
                    ...
                    service delivery, grievance redress mechanism, transparency
                    and accountability. Nodal Officers have been appointed with
                    a view to ensure effective implementation of Citizens’
                    Charter.
                  </p>
                </div>
                <div>
                      ...
                      <div className="col-lg-6 col-md-12 col-sm-12">
                        <div className="d-flex justify-content-end">
                          <a
                            ...
                            href="/ministry/about-us/details/Title=Abbreviations-gjN4AjMtQWa"
                          >
                            <span className="material-symbols-outlined bhashini-skip-translation">
                              Icon
                            </span>
              ...
              <div>
                <div>
                  ...
                  {[
                    {
                      title: "Background",
                      href: "/ministry/about-us/details/Title=Background-AzN4AjMtQWa",
                      id: "Background_1",
                    },
                    {
