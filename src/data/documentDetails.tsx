...
<section class="maincontent" role="main">
    ...
    <form class="form-group row align-items-start row-gap-2 filterbox filterBoxResponsive">
      <div class="col-md-12 col-lg-4">
        <div class="input-group searchField">
          ...
          <input type="search" name="scheme" aria-label="search" class="form-control" placeholder="Search..." />
      ...
      <div class="d-flex flex-wrap gap-2 align-items-center justify-content-between w-100">
        ...
        <div class="d-flex justify-content-end">
          <a
            id="btn-4fqhdx"
            type="pdf"
            class="download-btn d-flex align-items-center text-uppercase pointer"
            target="_blank"
    ...
    <div class="d-flex align-items-center gap-2">
      ...
      <div class="d-flex flex-wrap gap-2 align-items-center justify-content-between w-100">
        ...
        <div class="d-flex gap-4 align-items-center type-size">
          ...
          <small class="text-uppercase mb-0">3.17 MB</small>
        </div>
        ...
        <div class="d-flex justify-content-end">
          <a id="btn-3c9g5x"
            ...
            <span class="material-symbols-outlined bhashini-skip-translation">visibility</span>
            View
          </a>
        </div>
  ...
  <div class="col-sm-12 col-md-12 col-lg-7" role="cell">
    <div class="d-flex align-items-center gap-2">
      <small class="col-4 d-lg-none d-block text-uppercase table-column">Title:</small>
      <p class="mb-0">Detailed Demands for Grants 2024–2025</p>
    </div>
  </div>
  ...
  <div class="col-sm-12 col-md-12 col-lg-2" role="cell">
    <div class="d-flex align-items-center gap-2">
      <small class="col-4 d-lg-none d-block text-uppercase table-column">Published Year:</small>
      <small class="ptype mb-0">2024</small>
    </div>
  </div>
    ...
    <div class="d-flex align-items-center gap-2">
      ...
      <div class="d-flex flex-wrap gap-2 align-items-center justify-content-between w-100">
        ...
        <div class="d-flex gap-4 align-items-center type-size">
          ...
          <small class="text-uppercase mb-0" aria-label="PDF size 11.68 MB">11.68 MB</small>
        </div>
        ...
        <div class="d-flex justify-content-end">
          <a
            ...
            class="download-btn d-flex align-items-center text-uppercase pointer"
            target="_blank"
            href="https://www.meity.gov.in/static/uploads/2024/12/0da56d96676f8f0d43c8dbf51d21ba02.pdf"
          >
  ...
  <div class="col-sm-12 col-md-12 col-lg-7" role="cell">
    <div class="d-flex align-items-center gap-2">
      <small class="col-4 d-lg-none d-block text-uppercase table-column">Title: </small>
      <p class="mb-0">Detailed Demands for Grants 2023–2024</p>
    </div>
  </div>
  ...
  <div class="col-sm-12 col-md-12 col-lg-2" role="cell">
    <div class="d-flex align-items-center gap-2">
      <small class="col-4 d-lg-none d-block text-uppercase table-column">Published Year: </small>
      <small class="ptype mb-0">2023</small>
    </div>
  </div>
    ...
    <div class="d-flex align-items-center gap-2">
      ...
      <div class="d-flex flex-wrap gap-2 align-items-center justify-content-between w-100">
        ...
        <div class="d-flex gap-4 align-items-center type-size">
          ...
          <small class="text-uppercase mb-0" aria-label="PDF size 5.35 MB">5.35 MB</small>
        </div>

        <div class="d-flex justify-content-end">
          <a id="btn-xmva21" type="pdf" class="download-btn d-flex align-items-center text-uppercase pointer" target="_blank"
            href="https://www.meity.gov.in/static/uploads/2024/03/29ab.pdf">
            <span aria-hidden="true" class="material-symbols-outlined bhashini-skip-translation">visibility</span>
            View
          </a>
        </div>
  ...
  <div class="col-sm-12 col-md-12 col-lg-7" role="cell">
    <div class="d-flex align-items-center gap-2">
      <small class="col-4 d-lg-none d-block text-uppercase table-column">Title: </small>
      <p class="mb-0">Detailed Demands for Grants 2022-2023</p>
    </div>
  </div>
    ...
    <div class="d-flex align-items-center gap-2">
      ...
      <div class="d-flex flex-wrap gap-2 align-items-center justify-content-between w-100">
        ...
        <div class="d-flex gap-4 align-items-center type-size">
          ...
          <small class="text-uppercase mb-0" aria-label="PDF size 2.75 MB">2.75 MB</small>
        </div>

        <div class="d-flex justify-content-end">
          <a id="btn-g5em2y" type="pdf" class="download-btn d-flex align-items-center text-uppercase pointer"
            target="_blank"
            href="https://www.meity.gov.in/static/uploads/2024/03/30ab.pdf">
            <span aria-hidden="true" class="material-symbols-outlined bhashini-skip-translation">visibility</span>
            View
          </a>
        </div>
       ...
       <div 
  role="row" 
  class="announcementbox row row-gap-2 align-items-center ms-0 me-0"
>
  <div class="col-sm-12 col-md-12 col-lg-7" role="cell">
    <div class="d-flex align-items-center gap-2">
      <small class="col-4 d-lg-none d-block text-uppercase table-column">
        Title:
      </small>
      <p class="mb-0">Detailed Demands for Grants 2021-2022</p>
    </div>
  </div>
  ...
  <div class="col-sm-12 col-md-12 col-lg-2" role="cell">
    <div class="d-flex align-items-center gap-2">
      ...
      <small class="ptype mb-0">2021</small>
    </div>
  </div>
    ...
    <div class="d-flex align-items-center gap-2">
      ...
      <div class="d-flex flex-wrap gap-2 align-items-center justify-content-between w-100">
        <div class="d-flex gap-4 align-items-center type-size">
          ...
          <small class="text-uppercase mb-0">9.54 MB</small>
        </div>
        ...
        <div class="d-flex justify-content-end">
          <a
            ...
            class="download-btn d-flex align-items-center text-uppercase pointer"
            target="_blank"
            href="https://www.meity.gov.in/static/uploads/2024/03/31ab.pdf"
          >
            <span 
              aria-hidden="true"
              class="material-symbols-outlined bhashini-skip-translation"
            >
              visibility
            </span>
            View
...
>
  <div class="col-sm-12 col-md-12 col-lg-7" role="cell">
    <div class="d-flex align-items-center gap-2">
      ...
      <p class="mb-0">Detailed Demands for Grants 2020-2021</p>
    </div>
  </div>
  ...
  <div class="col-sm-12 col-md-12 col-lg-2" role="cell">
    <div class="d-flex align-items-center gap-2">
      ...
      <small class="ptype mb-0">2020</small>
    </div>
  </div>
    ...
    <div class="d-flex align-items-center gap-2">
      ...
      <div class="d-flex flex-wrap gap-2 align-items-center justify-content-between w-100">
        ...
        <div class="d-flex gap-4 align-items-center type-size">
          ...
          <small class="text-uppercase mb-0">9.23 MB</small>
        </div>
        ...
        <div class="d-flex justify-content-end">
          <a
            ...
            class="download-btn d-flex align-items-center text-uppercase pointer"
            target="_blank"
            href="https://www.meity.gov.in/static/uploads/2024/03/32ab.pdf"
          >
            <span 
              aria-hidden="true"
              class="material-symbols-outlined bhashini-skip-translation"
...
>
  <div class="col-sm-12 col-md-12 col-lg-7" role="cell">
    <div class="d-flex align-items-center gap-2">
      ...
      <p class="mb-0">Detailed Demands for Grants 2019-2020</p>
    </div>
  </div>
  ...
  <div class="col-sm-12 col-md-12 col-lg-2" role="cell">
    <div class="d-flex align-items-center gap-2">
      ...
      <small class="ptype mb-0">2019</small>
    </div>
  </div>
    ...
    <div class="d-flex align-items-center gap-2">
      ...
      <div class="d-flex flex-wrap gap-2 align-items-center justify-content-between w-100">
        ...
        <div class="d-flex gap-4 align-items-center type-size">
          ...
          <small class="text-uppercase mb-0">700.89 KB</small>
        </div>
        ...
        <div class="d-flex justify-content-end">
          <a
            ...
            class="download-btn d-flex align-items-center text-uppercase pointer"
            target="_blank"
            href="https://www.meity.gov.in/static/uploads/2024/03/33ab.pdf"
          >
            <span 
              aria-hidden="true" 
              class="material-symbols-outlined bhashini-skip-translation"
  ...
  <div class="col-sm-12 col-md-12 col-lg-7" role="cell">
    <div class="d-flex align-items-center gap-2">
      <small class="col-4 d-lg-none d-block text-uppercase table-column">Title: </small>
      <p class="mb-0">Detailed Demands for Grants 2018-2019</p>
    </div>
  </div>
  ...
  <div class="col-sm-12 col-md-12 col-lg-2" role="cell">
    <div class="d-flex align-items-center gap-2">
      <small class="col-4 d-lg-none d-block text-uppercase table-column">Published Year: </small>
      <small class="ptype mb-0">2018</small>
    </div>
  </div>
    ...
    <div class="d-flex align-items-center gap-2">
      ...
      <div class="d-flex flex-wrap gap-2 align-items-center justify-content-between w-100">
        ...
        <div class="d-flex gap-4 align-items-center type-size">
          ...
          <small class="text-uppercase mb-0" aria-label="PDF size 9.29 MB">9.29 MB</small>
        </div>

        <div class="d-flex justify-content-end">
          <a id="btn-kfp066" type="pdf" class="download-btn d-flex align-items-center text-uppercase pointer" target="_blank"
            href="https://www.meity.gov.in/static/uploads/2024/03/34ab.pdf">
            <span aria-hidden="true" class="material-symbols-outlined bhashini-skip-translation">visibility</span>
            View
          </a>
        </div>
      ...
      <!-- Row 2 (same pattern) -->
      <!-- You can continue similarly for other rows -->
    ...
    content: `
      <div class="content-box m-4 help-editor">
        <div class="mb-0 text-break tbborder">
          <h3>Outcome Budget 2015</h3>
          <p>Complete outcome budget documentation for the year 2015.</p>
