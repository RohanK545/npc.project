      ...
      <style>{`
        * {
        ...
        .social-media-container {
          background: linear-gradient(135deg, #2e3192 0%, #1e1f5e 100%);
          padding: 80px 120px;
        }
        ...
        .social-card-body::-webkit-scrollbar {
          width: 8px;
        }

        .social-card-body::-webkit-scrollbar-track {
          background: #f1f1f1;
        }

        .social-card-body::-webkit-scrollbar-thumb {
          background: #888;
          border-radius: 4px;
        }

        .social-card-body::-webkit-scrollbar-thumb:hover {
          background: #555;
        }
