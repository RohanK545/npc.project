      ...
      <div className=" ">
            ...
            <div className="container">
              <div className=" row">
                <div className="col-12">
                  <div className="d-flex justify-content-between align-items-center px-2 px-lg-4 py-1 small">
                    {/* LEFT: Skip Links */}
        ...
        <div className="container">
          <div className="row logobox align-items-center header-section-div">
            <div className="col-lg-4 px-4 col-md-12 col-xs-12 d-flex align-items-center justify-content-center order-1">
              <a
                href="#"
            ...
            <div className="col-lg-4 px-4 col-md-12 mt-3 col-xs-12 d-flex align-items-center justify-content-center header order-3 order-lg-2">
              <div className="searchposition w-100">
                <div className="d-flex align-items-center w-100 gap-2">
                  {/* Search – takes full width */}
                  <div className="input-group-header flex-grow-1">
                    <input
                      type="search"
                      aria-label="search"
                    ...
                    <button
                      className="search-icon-btn-header skip"
                      title="Search"
                    >
                  ...
                  {/* Menu icon – fixed size */}
                  <button
                    className="btn d-lg-none flex-shrink-0"
