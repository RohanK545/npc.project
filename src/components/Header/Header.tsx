          ...
          <div className="row align-items-center mb-flex">
            <div className="col-lg-8 pe-0">
              <div className="d-flex justify-content-start align-items-end mobilescr">
                <div className="col-lg-8 col-md-12 col-sm-12 col-12 pe-2">
                  <a className="logobox" href="#">
                    ...
                    <div className="pe-0 logotext">
                      ...
                      <h1 className="me-3 h4 h3-md h2-lg h1-xl text-break ministry-name-45 mb-0">
                ...
                <div className="col-lg-4 col-md-12 col-sm-12 col-12 ps-0 pe-0 pt-lg-4">
                  <div className="py-2 d-lg-none d-sm-block">
                    <div className="d-flex gap-5 justify-content-center align-items-center">
                      <div className="d-flex justify-content-start align-items-end gap-5 ms-4">
                        <a
                          target="_blank"
                          title="3c456855b01bd15e42e99b93982b5c18"
                          className=""
                  ...
                  <div className="d-flex justify-content-between align-items-center gap-2 searchposition mb-2">
                    ...
                    <ul className="menutop px-0 d-flex align-items-center mt-3 mb-0">
                ...
                <div className="d-none d-lg-flex justify-content-end align-items-end gap-3 mb-2">
                  <a href="#" className="logobox d-flex align-items-end">
                    <Image
                      src="/images/logos/state-emblem.png"
                  ...
                  <a href="#" className="logobox d-flex align-items-end gap-2">
                    <Image
                      src="/images/logos/npc_logo.png"
                      alt="National Productivity Council Logo"
                      width={80}
                    ...
                    <div className="logotext d-flex flex-column justify-content-end">
                      <p className="mb-1 govtext h5 h4-md h3-lg h2-xl">
                        Government of India
                      </p>
                      <h1 className="me-3 h4 h3-md h2-lg h1-xl text-break ministry-name-45 mb-0">
