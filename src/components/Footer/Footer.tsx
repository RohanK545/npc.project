          ...
          <div className="container">
            <div className="row ps-5 pe-5 d-none d-md-flex">
              <div className="usefullink col-md-8">
                <h3 role="heading">Useful Links</h3>
                ...
                <div style={{ textTransform: "none" }}>
                  <h4>
                    All donations towards the Prime Ministers National Relief
                    Fund(PMNRF) notified for 100% deduction from taxable income
                ...
                <div className="row align-items-end  gy-3">
                  <div className="col-12 col-md-4">
                    <Image
                      ...
                      alt="Logo 1"
                      width={180} // original width of your image
                      height={55}
            ...
            <div className="d-md-none" style={{ padding: "25px 20px" }}>
              ...
              <div style={{ textTransform: "none" }} className="text-center">
                <h4>
                  All donations towards the Prime Ministers National Relief
                  Fund(PMNRF) notified for 100% deduction from taxable income
                  under Section 80G of the Income Tax Act, 1961.
              ...
              <div className="row align-items-end text-center gy-3">
                <div className="col-12 col-md-4">
                  <Image
                    src="/images/footer/image1.png"
                    alt="Logo 1"
              ...
              <div className="mt-4 text-center">
                <h5>Last Updated On: 23.11.2025</h5>
              </div>
            </div>
          </div>
        </div>
